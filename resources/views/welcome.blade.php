            ...
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">Dashboard</a>
                @else
                ...
                @auth('admin')
                    <a
                        ...
                        class="-mx-4 text-sm text-gray-700 dark:text-gray-500 underline"
                    >
                        Admin Dashboard
                    </a>
                @else
